...
export default function TeamPage() {
  const attorneys = [
    {
      name: "Deepak Singh Dhaliwal",
      position: "Nationally Renowned Lawyer",
      specialization: "Civil Law, Family Law & Criminal Law",
      experience: "8+ Years",
      education: "Delhi Court Experience",
      bio: "Deepak Singh Dhaliwal is a nationally renowned lawyer who heads Shubh Legal Offices. As a well-known lawyer in the Delhi Court, he is a constant source of inspiration for us, making this law firm unparalleled.",
      achievements: [
  ...
  const supportStaff = [
    {
      ...
      specialization: "Case Management & Client Services",
      experience: "8+ Years",
      bio: "Our dedicated support team ensures smooth operations and exceptional client service across all practice areas.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              and personalized attention since 2017.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Experienced legal professional committed to achieving the best
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our dedicated support team ensures smooth operations and
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-orange-100 max-w-3xl mx-auto">
              The collective experience and dedication of our team translates
              into exceptional results for our clients.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Our team has 8+ years of combined experience across all practice areas.",
              },
              {
                icon: (
                  <svg
              ...
              },
              {
                ...
                description:
                  "We focus on achieving the best possible outcomes for our clients.",
              },
              {
                icon: (
                  <svg
                ...
                description:
                  "Our team is available around the clock for urgent legal matters.",
              },
              {
                icon: (
                  <svg
                ...
                description:
                  "Our team stays current with legal developments and best practices.",
              },
              {
                icon: (
                  <svg
